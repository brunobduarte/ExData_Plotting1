...
plot(h_power_sub$Date.Time, h_power_sub$Global_active_power,
     xlab = "",ylab = "Global Active Power (kilowatts)", type = "l")
plot(h_power_sub$Date.Time, h_power_sub$Voltage,
...
legend("topright", lty = c(1, 1, 1), col = c("black", "red", "blue"),
       ...
       cex = 0.85, bty = "n")
plot(h_power_sub$Date.Time, h_power_sub$Global_reactive_power,
